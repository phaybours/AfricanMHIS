...
namespace AMHC.DAL.Context
{
    public class AMHCContext : DbContext, IUnitOfWork
    {
        static AMHCContext()
        {
            Database.SetInitializer<AMHCContext>(null);
        }

        public AMHCContext() : base("BookStoreEntities")
        {
